                ...
                <div
                    ...
                    <div className="relative flex flex-col space-y-3">
                        ...
                        <div className="space-y-2">
                            ...
                            <p
                                className="text-sm max-[525px]:text-xs text-gray-600 dark:text-zinc-400 leading-snug font-[425]">
                                {item.description}
                            </p>
                        </div>
                        ...
                        <div className="flex items-center justify-between mt-2">
                            <div
                                ...
                                {item.tags?.map((tag, i) => (
                                    <span
                                        key={i}
                                        className="px-2 py-1 text-nowrap rounded-md bg-black/5 dark:bg-white/10 backdrop-blur-sm transition-all duration-200 hover:bg-black/10 dark:hover:bg-white/20">
                                        #{tag}
                                    </span>
                                ))}
                            </div>
